    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('buyer', 'Buyer'), ('seller', 'Seller'), ('firmadmin', 'FirmAdmin'), ('agent', 'Agent')], default='buyer', help_text='available choices -> buyer, seller, firmadmin, agent', max_length=32)),
